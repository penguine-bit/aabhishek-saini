...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us">when people were hopping from one Store to another for best bargains on an overall household’s monthly bill, E-Dakiya was being developed as a budget-friendly online bazaar in India.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@dvsiht.com</a></span>
                </div>
            </li>
