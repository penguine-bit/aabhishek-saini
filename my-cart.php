...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item"><b style="color:cornflowerblue;">Remove</b></th>
					<th class="cart-description item"><b style="color:cornflowerblue;">Image</b></th>
					<th class="cart-product-name item"><b style="color:cornflowerblue;">Product Name</b></th>
			
					<th class="cart-qty item"><b style="color:cornflowerblue;">Quantity</b></th>
					<th class="cart-sub-total item"><b style="color:cornflowerblue;">Price Per unit</b></th>
					<th class="cart-sub-total item"><b style="color:cornflowerblue;">Shipping Charge</b></th>
					<th class="cart-total last-item"><b style="color:cornflowerblue;">Grandtotal</b></th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
